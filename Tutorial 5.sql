...
use world;
select * from city;
select population from city where population=187122;
explain select population from city where population=187122;
create index Index_for_pop on city(population);
